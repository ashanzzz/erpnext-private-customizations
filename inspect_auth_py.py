...
# Let's inspect get_website_user_home_page
res = call_api('/api/method/frappe.auth.get_website_user_home_page', data={"user": USER})
print("get_website_user_home_page result:", res)
