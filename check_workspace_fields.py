...
def main():
    # fetch Workspace doctype to see its fields
    res = call_api('/api/resource/DocType/Workspace')
    if res and 'data' in res:
        fields = [f['fieldname'] for f in res['data']['fields']]
        print("Workspace fields:", fields)
