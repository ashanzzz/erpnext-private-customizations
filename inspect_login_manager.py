...
# Check System Settings & User home page
ss = call_api('/api/resource/System%20Settings/System%20Settings')
print("System Settings data:", ss.get('data', {}).get('default_home_page'))

u = call_api(f'/api/resource/User/{urllib.parse.quote(USER)}')
print("User data home_page:", u.get('data', {}).get('home_page'))
