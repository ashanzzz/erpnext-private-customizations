...
cmd = f"docker exec -u frappe -w /home/frappe/frappe-bench erpnext16 /home/frappe/frappe-bench/env/bin/python -c \"import frappe; frappe.init('site1.local'); frappe.connect(); {py_code}\""
