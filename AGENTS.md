...
2. **在册用工结构与“0工资 / 待设薪”动态感知**：
   - 界面与看板必须动态实时比对“外部车间实发数据”与“本地母表底册薪资”；
   - 若在册员工外部车间无出勤工资且本地母表未设置薪资，必须在用工结构看板中动态高亮呈现：
     - `🛡️ 社保公积金人员 (正式工): 18 人` *(若有未设薪者动态显示：其中 X人 0工资)*；
     - `👴 退休返聘人员: 5 人` *(若有未设薪者动态显示：其中 X人 0工资)*；
     - `🏷️ 其他人员合计 (临时/外籍): 2 人` *(若有未设薪者动态显示：其中 1人 0工资)*；
