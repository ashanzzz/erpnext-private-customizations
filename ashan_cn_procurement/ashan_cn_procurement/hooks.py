...
app_include_css = [
    "/assets/ashan_cn_procurement/css/ashan_cn_procurement.css?v=20260824.37",
    ...
    "/assets/ashan_cn_procurement/css/ashan_ui_kit.css?v=20260824.37",
]
...
# 避免在全 Desk 重复注册表单事件。
app_include_js = [
    "/assets/ashan_cn_procurement/js/ashan_ui_kit.js?v=20260824.37",
    "/assets/ashan_cn_procurement/js/ashan_cn_translations.js",
    "/assets/ashan_cn_procurement/js/ashan_cn_sidebar_v2.js?v=20260824.37",
