...
app_include_css = [
    "/assets/ashan_cn_procurement/css/ashan_cn_procurement.css?v=20260823.5",
    ...
    "/assets/ashan_cn_procurement/css/ashan_ui_kit.css?v=20260823.5",
]
...
app_include_js = [
    ...
    "/assets/ashan_cn_procurement/js/ashan_cn_sidebar_v2.js?v=20260823.5",
