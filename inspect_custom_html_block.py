...
chb = call_api('/api/resource/Custom%20HTML%20Block/Ashan%20Left%20Sidebar%20Block')
data = chb.get('data', {})
print("HTML snippet:", repr(data.get('html', ''))[:300])
print("Script snippet:", repr(data.get('script', ''))[:300])
