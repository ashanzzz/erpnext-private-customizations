...
def main():
    with sync_playwright() as p:
        ...
        for t in range(1, 11):
            page.wait_for_timeout(1000)
            print(f"[{t}s] Current URL: {page.url} | Page Title: {page.title()}")
            
        screenshot_path = r"C:\Users\ashan\.gemini\antigravity\brain\49a429d8-4554-471e-974e-f9d70d7ec2f8\user_login_reproduction.png"
        page.screenshot(path=screenshot_path)
        print(f"Saved reproduction screenshot to {screenshot_path}")
        browser.close()
