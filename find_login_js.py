...
req = urllib.request.Request(f"{SITE_URL}/assets/frappe/js/login.js")
try:
    resp = opener.open(req)
    print("login.js content length:", len(resp.read().decode('utf-8')))
except Exception as e:
    print("Error fetching login.js:", e)
