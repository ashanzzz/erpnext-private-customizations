...
SELECT idx, label, type, link_type, link_to, child, collapsible, indent, keep_closed FROM \`tabWorkspace Sidebar Item\` WHERE parent = 'CRM' ORDER BY idx ASC LIMIT 15;
"
"""
stdin, stdout, stderr = ssh.exec_command(cmd)
print("CRM SIDEBAR ITEMS IN DB:\n", stdout.read().decode('utf-8'))
ssh.close()
