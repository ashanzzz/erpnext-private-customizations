...
async def run():
    async with async_playwright() as p:
        ...
        # 截取正常流水全景
        await page.screenshot(path=os.path.join(OUTPUT_DIR, "oil_card_final_full_view.png"))

        # 打开录入加油行
        await page.click("#btn-quick-refuel")
        await asyncio.sleep(1)
        await page.screenshot(path=os.path.join(OUTPUT_DIR, "oil_card_final_inline_refuel.png"))

        await browser.close()
        print("[OK] Final full view captured!")
