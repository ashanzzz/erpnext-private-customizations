...
# 1. 设置 custom_blocks 子表
home_ws.custom_blocks = []
...
frappe.db.commit()
frappe.clear_cache()
print("[OK] Home Workspace custom_blocks child table & content configured successfully!")
"""

sftp = ssh.open_sftp()
with sftp.open('/tmp/fix_ws_custom_blocks.py', 'wb') as f:
    f.write(py_code.encode('utf-8'))

cmd1 = "docker cp /tmp/fix_ws_custom_blocks.py erpnext16:/tmp/fix_ws_custom_blocks.py"
cmd2 = "docker exec -u frappe -w /home/frappe/frappe-bench/sites erpnext16 /home/frappe/frappe-bench/env/bin/python3 /tmp/fix_ws_custom_blocks.py"
