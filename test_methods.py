...
def main():
    methods = [
        '/api/method/frappe.desk.desktop.get_desk_sidebar_items',
        '/api/method/frappe.desk.doctype.workspace.workspace.get_workspace_sidebar_items',
        '/api/method/frappe.desk.desktop.get_workspace_sidebar_items',
        '/api/method/frappe.desk.desktop.get_desktop_page',
        '/api/method/frappe.desk.doctype.workspace.workspace.get_workspace',
