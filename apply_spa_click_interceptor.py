...
// 2. Pure SPA Navigation Click Interceptor for Desk Workspace Links
if (typeof $ !== 'undefined') {
    $(document).on('click', 'a[href^="/desk/"], a[href^="/app/"]', function(e) {
        var href = $(this).attr('href');
        if (!href) return;
        
        // Skip links that have specific target or external download
...
// 3. Intercept /login success for seamless redirection
(function() {
...
res = call_api('/api/resource/Website%20Script/Website%20Script', method='PUT', data={"javascript": script})
print("Updated Website Script with SPA Router Click Interceptor:", res is not None)
