...
# 3. 查看税费相关会计科目 (Chart of Accounts)
...
# 4. 查看 Purchase Invoice Item 上已有的税率相关字段
...
# 5. 查看是否有已有的 Purchase Invoice 自定义字段或 Client Script
...
sftp = ssh.open_sftp()
with sftp.open('/tmp/inspect_tax_config.py', 'wb') as f:
    f.write(inspect_py.encode('utf-8'))

cmd1 = "docker cp /tmp/inspect_tax_config.py erpnext16:/tmp/inspect_tax_config.py"
cmd2 = "docker exec -u frappe -w /home/frappe/frappe-bench erpnext16 /home/frappe/frappe-bench/env/bin/python3 /tmp/inspect_tax_config.py"
