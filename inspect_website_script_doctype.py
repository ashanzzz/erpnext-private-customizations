...
res = call_api('/api/resource/DocType/Website%20Script')
if res and 'data' in res:
    print("Website Script DocType exists!")
    # Get current Website Script single doc
    ws_doc = call_api('/api/resource/Website%20Script/Website%20Script')
    print("Website Script content:", ws_doc)
else:
    print("Website Script DocType not found")
