...
def boot_session(bootinfo):
    \"\"\"
    Extend bootinfo with default workspace route.
    \"\"\"
    bootinfo.home_page = "my-business"
    bootinfo.default_route = "my-business"
"""

# Prepare clean hooks.py
...
website_redirects = [
    ...
    {"source": "/my-business", "target": "/desk/my-business"},
...
print("[OK] Copied boot.py and hooks.py to container")
