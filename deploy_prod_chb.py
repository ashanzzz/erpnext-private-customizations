...
frappe.db.commit()
frappe.clear_cache()
print("[OK] Production Permission-Aware Block updated in DB!")
"""

sftp = ssh.open_sftp()
with sftp.open('/tmp/deploy_prod_chb.py', 'wb') as f:
    f.write(py_code.encode('utf-8'))

cmd1 = "docker cp /tmp/deploy_prod_chb.py erpnext16:/tmp/deploy_prod_chb.py"
cmd2 = "docker exec -u frappe -w /home/frappe/frappe-bench/sites erpnext16 /home/frappe/frappe-bench/env/bin/python3 /tmp/deploy_prod_chb.py"
