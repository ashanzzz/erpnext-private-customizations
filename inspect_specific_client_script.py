...
res = call_api('/api/resource/Client%20Script/Ashan%20Default%20Dashboard%20Landing%20Script')
if res and 'data' in res:
    print("=== Ashan Default Dashboard Landing Script CONTENT ===")
    print(res['data'].get('script'))
